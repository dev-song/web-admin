  ...
  deleteItemData(path, itemId) {
    fs.readFile(path, 'utf8', (err, fileData) => {
      ...
      fs.writeFile(path, newData, err => {
        ...
        console.log(`Item ID ${itemId} is deleted!`);
      })
    })
  },
  updateItemData(path, itemId, building, space, description) {
    fs.readFile(path, 'utf8', (err, fileData) => {
      ...
      fs.writeFile(path, JSON.stringify(data, null, 2), err => {
        ...
        console.log(`Item ID ${itemId} is updated with the new data; building: ${building}, space: ${space}, description: ${description}`)
        this.sortProductData(path);
      })
    })
  }
